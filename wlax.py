...
SPORT_PATH      = "/Users/andyxin/Desktop/ECON135/FinalProject/wlax.xlsx"
SPORT_PREFIX    = "wlax"   # column names: wlax_confchamp, wlax_ncaa
...
for s_norm in sport_names:
    ...
    if result:
        ...
        records.append({
            ...
            "score":        score,
            "status":       "AUTO" if score >= 68 else "REVIEW",
        })
    else:
        records.append({
            "sport_school": sport_orig,
...
match_df.to_csv("wlax_match_review.csv", index=False)
print("\nSaved: wlax_match_review.csv")
...
merged.to_csv("ipeds_with_wlax.csv", index=False)
print(f"\nSaved: ipeds_with_wlax.csv")
