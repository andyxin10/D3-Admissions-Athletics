...
SPORT_PATH      = "/Users/andyxin/Desktop/ECON135/FinalProject/msoc.xlsx"
SPORT_PREFIX    = "msoc"   # column names: msoc_confchamp, msoc_ncaa
...
match_df.to_csv("msoc_match_review.csv", index=False)
print("\nSaved: msoc_match_review.csv")
...
merged.to_csv("ipeds_with_msoc.csv", index=False)
print(f"\nSaved: ipeds_with_msoc.csv")
