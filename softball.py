...
SPORT_PATH      = "/Users/andyxin/Desktop/ECON135/FinalProject/softball.xlsx"
SPORT_PREFIX    = "softball"   # column names: softball_confchamp, softball_ncaa
...
match_df.to_csv("softball_match_review.csv", index=False)
print("\nSaved: softball_match_review.csv")
...
merged.to_csv("ipeds_with_softball.csv", index=False)
print(f"\nSaved: ipeds_with_softball.csv")
