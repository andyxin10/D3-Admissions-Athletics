...
SPORT_PATH      = "/Users/andyxin/Desktop/ECON135/FinalProject/mbb.xlsx"
SPORT_PREFIX    = "mbb"   # column names: mbb_confchamp, mbb_ncaa
...
for s_norm in sport_names:
    ...
    if result:
        ...
        records.append({
            ...
            "score":        score,
            "status":       "AUTO" if score >= 75 else "REVIEW",
        })
    else:
        records.append({
            "sport_school": sport_orig,
...
match_df.to_csv("mbb_match_review.csv", index=False)
print("\nSaved: mbb_match_review.csv")
...
merged.to_csv("ipeds_with_mbb.csv", index=False)
print(f"\nSaved: ipeds_with_mbb.csv")
