...
SPORT_PATH      = "/Users/andyxin/Desktop/ECON135/FinalProject/baseball.xlsx"
SPORT_PREFIX    = "baseball"   # column names: baseball_confchamp, baseball_ncaa
...
for s_norm in sport_names:
    ...
    if result:
        ...
        records.append({
            ...
            "score":        score,
            "status":       "AUTO" if score >= 81 else "REVIEW",
        })
    else:
        records.append({
            "sport_school": sport_orig,
...
match_df.to_csv("baseball_match_review.csv", index=False)
print("\nSaved: baseball_match_review.csv")
...
merged.to_csv("ipeds_with_baseball.csv", index=False)
print(f"\nSaved: ipeds_with_baseball.csv")
