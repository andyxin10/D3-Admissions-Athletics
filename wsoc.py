...
SPORT_PATH      = "/Users/andyxin/Desktop/ECON135/FinalProject/wsoc.xlsx"
SPORT_PREFIX    = "wsoc"   # column names: wsoc_confchamp, wsoc_ncaa
...
match_df.to_csv("wsoc_match_review.csv", index=False)
print("\nSaved: wsoc_match_review.csv")
...
merged.to_csv("ipeds_with_wsoc.csv", index=False)
print(f"\nSaved: ipeds_with_wsoc.csv")
