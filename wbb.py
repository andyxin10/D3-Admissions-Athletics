...
SPORT_PATH      = "/Users/andyxin/Desktop/ECON135/FinalProject/wbb.xlsx"
SPORT_PREFIX    = "wbb"   # column names: wbb_confchamp, wbb_ncaa
...
match_df.to_csv("wbb_match_review.csv", index=False)
print("\nSaved: wbb_match_review.csv")
...
merged.to_csv("ipeds_with_wbb.csv", index=False)
print(f"\nSaved: ipeds_with_wbb.csv")
